// Denne tjenesten er for å hente data fra yr sitt API kalt Frost. 
...
namespace Gruppe5.Services
{
    public class WeatherService
    {
        ...
        public WeatherService(HttpClient httpClient, Gruppe5Context context)
        {
